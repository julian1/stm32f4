...
oct 31. 2023.
    got adc on. but have problem with offset.

configuration

- using lt1021/7V.  1ppm Vpp 0.1-10Hz.   as reference.
- lsk389 for amp.        will revert back to baseline jfe2140 when purchase more.
...
0.2V. indicates jfet Vos. 2mV. for lsk389
