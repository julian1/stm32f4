...
#include "calc.h"       // m_finput_binary()
#include "file-cal.h"
...
/*
    - This code is a mess, and should be made generic.
    - it should probably take a callback - to allow us to write any

    - likewise the scanning code.

  
    void file_slot( FILE *f,  size_t (*cb)( char *buf, size_t n ) , buf, size_t n ) 

    - or else we do it procedurall. 
*/
