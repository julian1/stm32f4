...
static void source_current_test_old(void)
{
  ...
  */
  ...
  usart1_printf("mux test finished\n\r");
}
...
void mux_regulate_on_vfb(void)
{
  ...
  */
  ...
  usart1_printf("regulate on vfb done\n\r");
}
...
static void dac_test(void)
{
  ...
  */
  ...
  usart1_printf("dac writing dac registers\n\r");
  ...
  */
  ...
  usart1_printf("dac test finished\n\r");
}
